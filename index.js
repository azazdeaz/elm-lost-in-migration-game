...
/***/ function(module, exports) {
	...
	Elm.Bird = Elm.Bird || {};
	Elm.Bird.make = function (_elm) {
	   "use strict";
	   _elm.Bird = _elm.Bird || {};
	   if (_elm.Bird.values) return _elm.Bird.values;
	   var _U = Elm.Native.Utils.make(_elm),
	   $Basics = Elm.Basics.make(_elm),
	   $Debug = Elm.Debug.make(_elm),
	   ...
	   var _op = {};
	   var bird = F4(function (sizeNumber,x,y,rotation) {
	      var size = function (times) {
	         return A2($Basics._op["++"],
	         " ",
	         $Basics.toString(sizeNumber * times));
	      };
	      return A2($Svg.svg,
	      _U.list([$Svg$Attributes.width(size(1))
	      ...
	      A2($Basics._op["++"],
	      size(0.2),
	      A2($Basics._op["++"],size(1)," Z")))))))))))))]),
	      _U.list([]))]));
	   });
	   var main = A4(bird,64,1,2,"180");
	   return _elm.Bird.values = {_op: _op,bird: bird,main: main};
	};
	...
	Elm.Types.make = function (_elm) {
	   ...
	   var _op = {};
	   var Answer = F2(function (a,b) {
	      return {ctor: "Answer",_0: a,_1: b};
	   });
	   var ResetScore = {ctor: "ResetScore"};
	   var ChangeScreen = function (a) {
	      return {ctor: "ChangeScreen",_0: a};
	   };
	...
	Elm.Flock = Elm.Flock || {};
	Elm.Flock.make = function (_elm) {
	   "use strict";
	   _elm.Flock = _elm.Flock || {};
	   if (_elm.Flock.values) return _elm.Flock.values;
	   var _U = Elm.Native.Utils.make(_elm),
	   $Array = Elm.Array.make(_elm),
	   $Basics = Elm.Basics.make(_elm),
	   $Bird = Elm.Bird.make(_elm),
	   $Debug = Elm.Debug.make(_elm),
	   $Html = Elm.Html.make(_elm),
	   $Html$Attributes = Elm.Html.Attributes.make(_elm),
	   $List = Elm.List.make(_elm),
	   ...
	   var _op = {};
	   var flockView = F4(function (fieldForm,seed,width,height) {
	      var _p0 = A2($Random.generate,
	      A2($Random.$int,34,height - 120),
	      seed);
	      var top = _p0._0;
	      var seed$$ = _p0._1;
	      var _p1 = A2($Random.generate,
	      A2($Random.$int,12,width - 120),
	      seed);
	      var left = _p1._0;
	      var seed$ = _p1._1;
	      var directionToDegree = function (direction) {
	         var _p2 = direction;
	         switch (_p2.ctor)
	         {case "Up": return "-90";
	            case "Right": return "0";
	      ...
	      var f = F3(function (x,y,field) {
	         var rotation = function () {
	            var _p3 = field;
	            if (_p3.ctor === "Empty") {
	                  return "";
	               } else {
	                  return directionToDegree(_p3._0);
	               }
	         }();
	         return _U.eq(rotation,
	         "") ? $Html.text(rotation) : A4($Bird.bird,21,x,y,rotation);
	      });
	      var _p4 = fieldForm;
	      var a1 = _p4._0._0;
	      var b1 = _p4._0._1;
	      ...
	      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                              ...
	                                              ,{ctor: "_Tuple2"
	                                               ,_0: "left"
	                                               ,_1: A2($Basics._op["++"],$Basics.toString(left),"px")}
	                                              ,{ctor: "_Tuple2"
	                                               ,_0: "top"
	                                               ,_1: A2($Basics._op["++"],$Basics.toString(top),"px")}]))]),
	      _U.list([A3(f,0,0,a1)
	              ,A3(f,1,0,b1)
	              ,A3(f,2,0,c1)
	              ,A3(f,3,0,d1)
	   ...
	   var O = {ctor: "O"};
	   var I = {ctor: "I"};
	   var crossForm = {ctor: "_Tuple5"
	                   ,_0: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: I,_4: I}
	                   ,_1: {ctor: "_Tuple5",_0: I,_1: I,_2: O,_3: I,_4: I}
	                   ,_2: {ctor: "_Tuple5",_0: I,_1: O,_2: X,_3: O,_4: I}
	                   ,_3: {ctor: "_Tuple5",_0: I,_1: I,_2: O,_3: I,_4: I}
	                   ,_4: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: I,_4: I}};
	   var upForm = {ctor: "_Tuple5"
	                ,_0: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: I,_4: I}
	                ,_1: {ctor: "_Tuple5",_0: I,_1: I,_2: X,_3: I,_4: I}
	                ,_2: {ctor: "_Tuple5",_0: I,_1: O,_2: I,_3: O,_4: I}
	                ,_3: {ctor: "_Tuple5",_0: O,_1: I,_2: I,_3: I,_4: O}
	                ,_4: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: I,_4: I}};
	   var rightForm = {ctor: "_Tuple5"
	                   ,_0: {ctor: "_Tuple5",_0: I,_1: O,_2: I,_3: I,_4: I}
	                   ,_1: {ctor: "_Tuple5",_0: I,_1: I,_2: O,_3: I,_4: I}
	                   ,_2: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: X,_4: I}
	                   ,_3: {ctor: "_Tuple5",_0: I,_1: I,_2: O,_3: I,_4: I}
	                   ,_4: {ctor: "_Tuple5",_0: I,_1: O,_2: I,_3: I,_4: I}};
	   var downForm = {ctor: "_Tuple5"
	                  ,_0: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: I,_4: I}
	                  ,_1: {ctor: "_Tuple5",_0: O,_1: I,_2: I,_3: I,_4: O}
	                  ,_2: {ctor: "_Tuple5",_0: I,_1: O,_2: I,_3: O,_4: I}
	                  ,_3: {ctor: "_Tuple5",_0: I,_1: I,_2: X,_3: I,_4: I}
	                  ,_4: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: I,_4: I}};
	   var leftForm = {ctor: "_Tuple5"
	                  ,_0: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: O,_4: I}
	                  ,_1: {ctor: "_Tuple5",_0: I,_1: I,_2: O,_3: I,_4: I}
	                  ,_2: {ctor: "_Tuple5",_0: I,_1: X,_2: I,_3: I,_4: I}
	                  ,_3: {ctor: "_Tuple5",_0: I,_1: I,_2: O,_3: I,_4: I}
	                  ,_4: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: O,_4: I}};
	   var verticalForm = {ctor: "_Tuple5"
	                      ,_0: {ctor: "_Tuple5",_0: I,_1: I,_2: O,_3: I,_4: I}
	                      ,_1: {ctor: "_Tuple5",_0: I,_1: I,_2: O,_3: I,_4: I}
	                      ,_2: {ctor: "_Tuple5",_0: I,_1: I,_2: X,_3: I,_4: I}
	                      ,_3: {ctor: "_Tuple5",_0: I,_1: I,_2: O,_3: I,_4: I}
	                      ,_4: {ctor: "_Tuple5",_0: I,_1: I,_2: O,_3: I,_4: I}};
	   var horisontalForm = {ctor: "_Tuple5"
	                        ,_0: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: I,_4: I}
	                        ,_1: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: I,_4: I}
	                        ,_2: {ctor: "_Tuple5",_0: O,_1: O,_2: X,_3: O,_4: O}
	                        ,_3: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: I,_4: I}
	                        ,_4: {ctor: "_Tuple5",_0: I,_1: I,_2: I,_3: I,_4: I}};
	   var forms = _U.list([crossForm
	                       ,upForm
	                       ,rightForm
	                       ,downForm
	                       ,leftForm
	                       ,verticalForm
	                       ,horisontalForm]);
	   var Bird = function (a) {    return {ctor: "Bird",_0: a};};
	   var Empty = {ctor: "Empty"};
	   var markupToField = F3(function (markup,oField,xField) {
	      var _p5 = markup;
	      switch (_p5.ctor)
	      {case "I": return Empty;
	         case "O": return oField;
	         default: return xField;}
	   });
	   var markupFormToFieldForm = F3(function (markupForm,
	   oField,
	   xField) {
	      var f = function (markup) {
	         return A3(markupToField,markup,oField,xField);
	      };
	      var _p6 = markupForm;
	      var a1 = _p6._0._0;
	      var b1 = _p6._0._1;
	   ...
	   var getRandomFlock = F2(function (seed,middleDirection) {
	      var directions = $Array.fromList(_U.list([$Types.Up
	                                               ,$Types.Left
	                                               ,$Types.Right
	                                               ,$Types.Down]));
	      var _p7 = A2($Random$Array.sample,seed,$Array.fromList(forms));
	      var maybeForm = _p7._0;
	      var seed$ = _p7._1;
	      var _p8 = A2($Random$Array.sample,seed$,directions);
	      var maybeDirection = _p8._0;
	      var seed$$ = _p8._1;
	      var direction = A2($Maybe.withDefault,
	      $Types.Left,
	      maybeDirection);
	      var form = A2($Maybe.withDefault,crossForm,maybeForm);
	      var fieldForm = A3(markupFormToFieldForm,
	      form,
	      Bird(direction),
	      Bird(middleDirection));
	      return {ctor: "_Tuple2",_0: fieldForm,_1: seed$$};
	   });
	   var view = function (model) {
	      var _p9 = A2(getRandomFlock,model.seed,model.goodDirection);
	      var flock = _p9._0;
	      var seed = _p9._1;
	      return A4(flockView,
	      flock,
	   ...
	   return _elm.Flock.values = {_op: _op
	                              ,Empty: Empty
	                              ,Bird: Bird
	                              ,I: I
	                              ,O: O
	                              ...
	                              ,horisontalForm: horisontalForm
	                              ,forms: forms
	                              ,markupToField: markupToField
	                              ,markupFormToFieldForm: markupFormToFieldForm
	                              ,getRandomFlock: getRandomFlock
	                              ,flockView: flockView
	                              ,view: view};
	};
	Elm.Game = Elm.Game || {};
	Elm.Game.make = function (_elm) {
	   ...
	   var _op = {};
	   var view = function (model) {
	      var time = $Basics.truncate(model.gameElapsedTime / $Time.second);
	      return A2($Html.div,
	      _U.list([]),
	      _U.list([$Html.text(A2($Basics._op["++"],
	              ...
	              "Time: ",
	              $Basics.toString(time)))
	              ,$Flock.view(model)]));
	   };
	   return _elm.Game.values = {_op: _op,view: view};
	};
	Elm.Html = Elm.Html || {};
	...
	Elm.Main.make = function (_elm) {
	   ...
	   $Types = Elm.Types.make(_elm);
	   var _op = {};
	   var keysToAnswer = function (_p0) {
	      var _p1 = _p0;
	      var _p2 = {ctor: "_Tuple2",_0: _p1.x,_1: _p1.y};
	      _v1_4: do {
	         if (_p2.ctor === "_Tuple2") {
	               switch (_p2._0)
	               {case 1: if (_p2._1 === 0) {
	                          return $Types.Answer($Types.Right);
	                       } else {
	                          break _v1_4;
	                       }
	                  case 0: switch (_p2._1)
	                    {case 1: return $Types.Answer($Types.Up);
	                       case -1: return $Types.Answer($Types.Down);
	                       default: break _v1_4;}
	                  case -1: if (_p2._1 === 0) {
	                          return $Types.Answer($Types.Left);
	                       } else {
	                          break _v1_4;
	                       }
	                  default: break _v1_4;}
	   ...
	   var isArrowPressed = function (_p3) {
	      var _p4 = _p3;
	      return A2($Basics.xor,!_U.eq(_p4.x,0),!_U.eq(_p4.y,0));
	   };
	   var answer = A2($Signal.map,
	   function (_p5) {
	      var _p6 = _p5;
	      return _p6._1(_p6._0);
	   },
	   ...
	   {x: 1,y: 0},
	   $Keyboard.arrows))));
	   var inbox = $Signal.mailbox($Types.NoOp);
	   var tick = A2($Signal.map,
	   function (delta) {
	      return $Types.Tick(delta);
	   },
	   $Time.fps(60));
	   var input = $Signal.mergeMany(_U.list([answer
	                                         ,inbox.signal
	                                         ,tick]));
	   var frame = F2(function (model,content) {
	      return A2($Html.div,
	      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                               ,_0: "width"
	                                               ,_1: A2($Basics._op["++"],
	                                               $Basics.toString(model.gameWidth),
	                                               "px")}
	                                              ,{ctor: "_Tuple2"
	                                               ,_0: "height"
	                                               ,_1: A2($Basics._op["++"],
	                                               $Basics.toString(model.gameHeight),
	                                               "px")}
	                                              ,{ctor: "_Tuple2",_0: "background-color",_1: "#7FDBFF"}
	                                              ,{ctor: "_Tuple2",_0: "poistion",_1: "absolute"}]))]),
	      _U.list([content]));
	   });
	   var menu = function (address) {
	      return A2($Html.div,
	      _U.list([]),
	      _U.list([A3($Html.node,
	              ...
	              _U.list([A2($Html$Events.onClick,
	                      address,
	                      $Types.ChangeScreen($Types.Game))
	                      ,$Html$Attributes.$class("--google-blue-500")]),
	              _U.list([$Html.text("Game")]))
	              ,A3($Html.node,
	              "paper-button",
	              _U.list([A2($Html$Events.onClick,
	              address,
	              $Types.ChangeScreen($Types.HowTo))]),
	              _U.list([$Html.text("How To?")]))]));
	   };
	   var view = F2(function (address,model) {
	      var content = function () {
	         var _p7 = model.screen;
	         switch (_p7.ctor)
	         {case "Menu": return menu(address);
	            case "Game": return $Game.view(model);
	            default: return $Html.text("HowTo");}
	      }();
	      return A2(frame,model,content);
	   });
	   var update = F2(function (action,model) {
	      var nextScore = F2(function (model,answerDirection) {
	         return _U.eq(model.goodDirection,
	         answerDirection) ? model.score + 200 : model.score;
	      });
	      var answers = $Array.fromList(_U.list([$Types.Up
	                                            ,$Types.Left
	                                            ,$Types.Right
	                                            ,$Types.Down]));
	      var seed = function (time) {
	         return $Random.initialSeed($Basics.round(time));
	      };
	      var generateNextDirection = function (time) {
	         return A2($Random$Array.sample,seed(time),answers);
	      };
	      var direction = function (time) {
	         return A2($Maybe.withDefault,
	         $Types.Left,
	         $Basics.fst(generateNextDirection(time)));
	      };
	      var setAnswer = F3(function (model,answerDirection,time) {
	         return _U.update(model,
	         {score: A2(nextScore,model,answerDirection)
	         ,seed: $Basics.snd(generateNextDirection(time))
	         ,goodDirection: direction(time)});
	      });
	      var _p8 = action;
	      switch (_p8.ctor)
	      {case "NoOp": return model;
	         case "Tick": return _U.eq(model.screen,
	           $Types.Game) ? _U.update(model,
	           {gameElapsedTime: model.gameElapsedTime + _p8._0}) : model;
	         case "ChangeScreen": var _p9 = _p8._0;
	           return _U.update(model,
	           {screen: _p9
	           ,gameElapsedTime: _U.eq(_p9,
	           $Types.Game) ? 0 : model.gameElapsedTime});
	         case "ResetScore": return _U.update(model,{score: 0});
	         default: return A3(setAnswer,model,_p8._0,_p8._1);}
	   });
	   var initialModel = {screen: $Types.Menu
	                      ,seed: $Random.initialSeed(0)
	                      ,goodDirection: $Types.Left
	                      ,score: 200
	                      ,gameElapsedTime: 0
	                      ,gameWidth: 600
	                      ,gameHeight: 400};
