...
/***/ function(module, exports, __webpack_require__) {
	...
	Elm.Bird.make = function (_elm) {
	   ...
	   var bird = F4(function (sizeNumber,
	   x,
	   y,
	   rotation) {
	      return function () {
	         ...
	         return A2($Svg.svg,
	         _L.fromArray([$Svg$Attributes.width(size(1))
	         ...
	         _L.fromArray([$Svg$Attributes.d(A2($Basics._op["++"],
	         "M",
	         A2($Basics._op["++"],
	         size(0.8),
	         A2($Basics._op["++"],
	...
	Elm.Flock.make = function (_elm) {
	   ...
	   if (_elm.Flock.values)
	   return _elm.Flock.values;
	   var _op = {},
	   _N = Elm.Native,
	   _U = _N.Utils.make(_elm),
	   _L = _N.List.make(_elm),
	   ...
	   var flockView = function (fieldForm) {
	      return function () {
	         ...
	         field) {
	            return function () {
	               var rotation = function () {
	                  switch (field.ctor)
	                  {case "Bird":
	                     return directionToDegree(field._0);
	                     case "Empty": return "";}
	                  _U.badCase($moduleName,
	                  "between lines 169 and 174");
	               }();
	               return _U.eq(rotation,
	               "") ? $Html.text(rotation) : A4($Bird.bird,
	               21,
	               x,
	               y,
	               rotation);
	   ...
	   var horisontalForm = {ctor: "_Tuple5"
	                        ...
	                        ,_4: {ctor: "_Tuple5"
	                             ...
	                             ,_3: I
	                             ,_4: I}};
	   var forms = _L.fromArray([crossForm
	                            ,upForm
	                            ,rightForm
	                            ,downForm
	                            ,leftForm
	                            ...
	                            ,horisontalForm]);
	   var Bird = function (a) {
	      return {ctor: "Bird",_0: a};
	   };
	   var Empty = {ctor: "Empty"};
	   var markupToField = F3(function (markup,
	   oField,
	   xField) {
	      return function () {
	         switch (markup.ctor)
	   ...
	   var getRandomFlock = F2(function (seed,
	   middleDirection) {
	      return function () {
	         var directions = $Array.fromList(_L.fromArray([$Types.Up
	                                                       ,$Types.Left
	                                                       ,$Types.Right
	                                                       ,$Types.Down]));
	         var $ = A2($Random$Array.sample,
	         seed,
	         $Array.fromList(forms)),
	         maybeForm = $._0,
	         seed$ = $._1;
	         var $ = A2($Random$Array.sample,
	         seed$,
	         ...
	         $Types.Left,
	         maybeDirection);
	         var form = A2($Maybe.withDefault,
	         crossForm,
	         maybeForm);
	         return A3(markupFormToFieldForm,
	         form,
	         Bird(direction),
	   ...
	   var view = function (model) {
	      return flockView(A2(getRandomFlock,
	      model.seed,
	      model.goodDirection));
	   };
	   _elm.Flock.values = {_op: _op
	                       ,Empty: Empty
	                       ,Bird: Bird
	                       ,I: I
	                       ,O: O
	...
	Elm.Main.make = function (_elm) {
	            ...
	            {case "_Tuple2": switch (_v2._0)
	                 {case -1: switch (_v2._1)
	                    ...
	                    case 0: switch (_v2._1)
	                      {case -1:
	                         return $Types.Answer($Types.Down);
	                         case 1:
	                         return $Types.Answer($Types.Up);}
	                      break;
	                    case 1: switch (_v2._1)
	                      {case 0:
	   ...
	   var isArrowPressed = function (_v5) {
	      return function () {
	   ...
	   var answer = $Signal.map(function (_v7) {
	      return function () {
	         switch (_v7.ctor)
	         {case "_Tuple2":
	            return _v7._1(_v7._0);}
	         _U.badCase($moduleName,
	         "on line 131, column 39 to 50");
	      }();
	   })($Time.timestamp($Signal.map(keysToAnswer)(A2($Signal.filter,
	   isArrowPressed,
	   {_: {}
	   ,x: 1
	   ,y: 0})($Keyboard.arrows))));
	   ...
	   var menu = function (address) {
	      ...
	      _L.fromArray([A3($Html.node,
	                   ...
	                   _L.fromArray([$Html.text("Game")]))
	                   ,A3($Html.node,
	                   "paper-button",
	                   _L.fromArray([A2($Html$Events.onClick,
	                   address,
	                   $Types.ChangeScreen($Types.HowTo))]),
	                   _L.fromArray([$Html.text("How To?")]))]));
	   };
	   ...
	   model) {
	      return function () {
	         var nextScore = F2(function (model,
	         answerDirection) {
	            return _U.eq(model.goodDirection,
	            answerDirection) ? model.score + 200 : model.score;
	         });
	         var answers = $Array.fromList(_L.fromArray([$Types.Up
	                                                    ,$Types.Left
	                                                    ,$Types.Right
	                                                    ,$Types.Down]));
	         ...
	         var generateNextDirection = function (time) {
	            return A2($Random$Array.sample,
	            seed(time),
	            answers);
	         };
	         var direction = function (time) {
	            return $Maybe.withDefault($Types.Left)($Basics.fst(generateNextDirection(time)));
	         };
	         var setAnswer = F3(function (model,
	         answerDirection,
	         time) {
	            return _U.replace([["score"
	                               ...
	                               answerDirection)]
	                              ,["seed"
	                               ,$Basics.snd(generateNextDirection(time))]
	                              ,["goodDirection"
	                               ,direction(time)]],
	            model);
	         });
	...
	Elm.Random.Array.make = function (_elm) {
	   ...
	   arr) {
	      return $Array.isEmpty(arr) ? {ctor: "_Tuple3"
	                                   ,_0: $Maybe.Nothing
	                                   ,_1: seed
	                                   ,_2: arr} : function () {
	   ...
	   arr) {
	      return $Array.isEmpty(arr) ? {ctor: "_Tuple2"
	                                   ,_0: arr
	                                   ,_1: seed} : function () {
